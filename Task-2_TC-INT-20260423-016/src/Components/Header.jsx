...
function Header() {
  ...
  return (
    <header className="w-full h-[10vh] flex items-center justify-between px-4 sticky top-0 z-50">
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-[10vh] left-0 w-full bg-white shadow-md md:hidden z-40">
