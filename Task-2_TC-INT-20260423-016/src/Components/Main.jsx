    ...
    <div className="w-full min-h-screen bg-[#020817] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-20 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="max-w-2xl">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 border border-green-500/30 bg-green-500/10 px-5 py-2 rounded-full text-green-400 text-sm font-semibold mb-8">
          ...
          <p className="text-gray-400 text-lg leading-9 mt-8 max-w-xl">
            ...
            high-performance web apps, mobile solutions, and custom
            software for businesses worldwide.
          </p>

          {/* Buttons */}
          <div className="flex gap-5 mt-10 flex-wrap">
            <button className="bg-green-500 hover:bg-green-400 text-black font-semibold px-8 py-4 rounded-xl shadow-[0_0_25px_rgba(34,197,94,0.5)] transition">
              Start a Project
            </button>

            <button className="border border-green-500/30 hover:bg-green-500/10 px-8 py-4 rounded-xl font-semibold transition">
              View Our Work
            </button>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative text-center">
            <p className="text-green-500 text-xl tracking-[5px] mt-4">
              <img src={Logo} alt="" />
            </p>
          </div>
        </div>
